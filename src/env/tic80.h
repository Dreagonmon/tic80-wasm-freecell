...
WASM_IMPORT("pmem")
// Access or update the persistent memory. Param `address` must in range [0, 255]. Pass -1 to `value` will not update the value.
...
WASM_IMPORT("trace")
// Print a string to the Console. Pass -1 to `color` will use the default color(15).
